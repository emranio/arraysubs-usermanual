...
updated: 2026-06-16T18:53:18.376271+06:00
started: 2026-06-16T18:36:21.82234+06:00
class: standard
---
...
Manual page examined: `user-manual/markdowns/store-credit/emails.md`.
Future capture should create `markdowns/store-credit/emails.assets/` and start numbering at `01`.
...
Code scan terms: `store`, `credit`, `emails`, `email`, `configure`, `added`, `used`, `expiring`, `expired`, `expiration`.
