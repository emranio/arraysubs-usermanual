...
const routeHints = new Map([
  ...
  ["manage-members/README.md", "/wp-admin/admin.php?page=arraysubs-mainadmin#/manage-members"],
  ...
  ["audits-and-logs/gateway-health-dashboard.md", "/wp-admin/admin.php?page=arraysubs-mainadmin#/settings/gateways"],
