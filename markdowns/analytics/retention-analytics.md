...
![The Retention report tracks cancellations and saves](retention-analytics.assets/01-retention-report-annotated.png)

![The full Retention report — KPI cards, churn reasons, and offer breakdown](retention-analytics.assets/02-retention-full-annotated.png)
