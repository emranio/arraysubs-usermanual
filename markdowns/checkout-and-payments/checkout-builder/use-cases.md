...
| Step 3: Payment | Coupon and Notices · Order Info and Payment |

**Why it works:** The multi-step flow separates the fun part (customizing the box) from the payment part. Dietary preferences are captured once and copied to the subscription (`Copy Custom Fields to Subscriptions` enabled), so the fulfillment team sees them on every renewal order (`Copy Custom Fields to Renewal Orders` enabled).
...
| Step 3: Review & Pay | Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Subscription Details ✅, Show on Admin Order Details ✅
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅
...
| Step 2: Account & Payment | Billing Address · Coupon and Notices · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Subscription Details ✅
...
| Step 3: Delivery & Payment | Shipping Address · Calendar: "Preferred Delivery Day" (disabled dates: Sundays) · Coupon and Notices · Order Info and Payment |
...
| Step 3: Payment | Billing Address · Order Notes · Coupon and Notices · Order Info and Payment |

**Why it works:** B2B checkouts often need structured data beyond what WooCommerce provides. The PO number appears on every renewal invoice (with `Copy Custom Fields to Renewal Orders` enabled), making accounts payable reconciliation simple.

**Key settings:** Copy Custom Fields to Subscriptions ✅, Copy Custom Fields to Renewal Orders ✅, Show on Admin Order Details ✅, Show on Customer Order Details ✅
...
| Step | Fields |
| --- | --- |
| Step 1: About Your Pet | Heading: "Tell Us About Your Furry Friend" · Text: "Pet's Name" (required) · Select: "Pet Type" (Dog, Cat) · Select: "Breed Size" (Small, Medium, Large, Giant) — visibility: shown only when Pet Type = Dog · Select: "Age Range" (Puppy/Kitten, Adult, Senior) · Multi-Select: "Allergies" (Chicken, Beef, Grain, Dairy, None) · File Upload: "Photo of Your Pet" (allowed types: image, max size: 2MB) |
| Step 2: Delivery & Payment | Shipping Address · Coupon and Notices · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Copy Custom Fields to Renewal Orders ✅, Show on Admin Order Details ✅, Allow File Uploads ✅
...
| Step 2: Payment | Billing Address · Coupon and Notices · Order Info and Payment |
...
| Step 2: Directory Listing | Heading: "Member Directory" · Paragraph: "Opt in to be listed in our public member directory. Your name and professional details will be visible to other members." · Toggle: "List me in the member directory" · Text: "Directory Display Name" — visibility: shown when toggle is on · Textarea: "Professional Bio (150 words)" — visibility: shown when toggle is on · File Upload: "Professional Headshot" (allowed types: image, max size: 1MB) — visibility: shown when toggle is on |
| Step 3: Payment | Billing Address · Coupon and Notices · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅, Allow File Uploads ✅
...
| Step 3: Payment | Alert (info): "Your first delivery will be scheduled within 5 business days." · Coupon and Notices · Order Info and Payment |
...
| Step 2: Brand Details | Color Picker: "Primary Brand Color" · Color Picker: "Secondary Brand Color" · File Upload: "Brand Guidelines / Logo" (allowed types: image, pdf, max size: 10MB, max count: 3) · Multi-Select: "Target Audience" (B2B, B2C, Young Adults, Professionals, Parents, Seniors) |
| Step 3: Company & Payment | Billing Address · Text: "Purchase Order Number" · Order Notes · Coupon and Notices · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅, Show on Subscription Details ✅, Allow File Uploads ✅, Default Max File Size (MB): 10MB
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅, Show on Customer Order Details ✅
...
| Step | Fields |
| --- | --- |
| Step 1: Attendee Information | Section (2 columns): Left: Text "Badge Name" (required, help text: "Name to print on your badge"), Text "Job Title"; Right: Text "Company", Select "T-Shirt Size" (XS, S, M, L, XL, 2XL) · File Upload: "Professional Headshot" (allowed types: image, max size: 2MB, help text: "Used for event programs and networking app") |
...
| Step 3: Payment | Billing Address · Alert (success): "Your pass includes all events for 12 months from purchase date." · Coupon and Notices · Order Info and Payment |
...
| Step 3: Payment | Alert (info): "Gift subscriptions ship to the recipient's address. You will receive the invoice at your billing address." · Coupon and Notices · Order Info and Payment |
...
| Step 3: Consent & Payment | Paragraph: "By proceeding, you consent to our telehealth terms and acknowledge that this subscription does not replace emergency medical care." · Checkbox: "I agree to the telehealth terms of service" (required) · Billing Address · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅, Allow File Uploads: No (no file uploads needed for this use case)
...
| Step 3: Payment | Billing Address · Alert (info): "Your access card will be ready for pickup at the front desk within 24 hours of purchase." · Coupon and Notices · Order Info and Payment |
...
**Key settings:** Copy Custom Fields to Subscriptions ✅, Show on Admin Order Details ✅, Copy Custom Fields to Renewal Orders ✅
...
| Step 3: Brand Assets | Heading: "Upload Your Brand Materials" · File Upload: "Logo Files" (allowed types: image, pdf, max size: 10MB, max count: 5) · File Upload: "Brand Guidelines" (allowed types: pdf, doc, max size: 10MB) · Color Picker: "Primary Brand Color" · Color Picker: "Secondary Brand Color" · Textarea: "Social Media Account URLs" (placeholder: "List your Facebook, Instagram, LinkedIn, Twitter URLs — one per line") |
| Step 4: Payment | Billing Address · Text: "Purchase Order / Reference Number" · Order Notes · Coupon and Notices · Order Info and Payment |
...
| Need | Setting |
| --- | --- |
| Fulfillment team needs custom data on every renewal order | Copy Custom Fields to Subscriptions ✅ + Copy Custom Fields to Renewal Orders ✅ |
| Admin needs to see custom data on orders | Show on Admin Order Details ✅ |
| Customer should see their submitted data on the order receipt | Show on Customer Order Details ✅ |
| Custom data should appear on subscription detail | Show on Subscription Details ✅ |
...
-   [Field Types Reference](field-types.md) — Detailed reference for all 28 element types
