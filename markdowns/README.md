...
The manual follows product ownership:

- shared store-wide settings live in **Settings**
- feature-owned workflows live inside their own module guides
- Pro-only capabilities are labeled with *(Pro)* in the relevant documentation instead of being duplicated everywhere
